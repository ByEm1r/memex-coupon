...
const categories = [
  ...
  'Crypto', 'Casino', 'E-Commerce', 'Other'
];
    ...
    try {
      const { error: updateError } = await supabase
          ...
          .update({
            ...
            transaction_hash: profileFormData.transactionHash
          })
          .eq('id', user.id);
      ...
      const updatedUser = {
        ...
        transaction_hash: updatedUserData.transaction_hash
      };
