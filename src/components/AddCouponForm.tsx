...
const currencies = [
  ...
  { code: 'MEMEX', symbol: 'MEMEX', name: 'MEMEX Token' }
];
...
const AddCouponForm: React.FC<AddCouponFormProps> = ({
  ...
  useEffect(() => {
    if (editingCoupon) {
      setFormData({
        ...
        currency: editingCoupon.currency || 'MEMEX'
      });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const submissionData = {
      ...
      brand: formData.brand || user?.store_name,
      user_id: user?.id
    };
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <input
                    type="number"
                    name={discountType === 'percentage' ? 'percentage_discount' : 'fixed_discount'}
